...
import { LayoutDashboard, Users, LogOut, Menu, X, Bell, ChevronLeft, Settings, User as UserIcon, LogOut as LogOutIcon, Settings as SettingsIcon, ChevronDown, Wifi } from 'lucide-react';
...
const menuItems = [
    ...
    { name: 'Applications', href: '/partner/chancen', icon: Users },
...
export default function PartnerLayout({ children }: { children: React.ReactNode }) {
    ...
    if (pathname && pathname.startsWith('/partner/login')) return <>{children}</>;
                        ...
                        <div ref={profileRef} className="relative">
                            ...
                            >
                                <div className="text-sm text-right hidden lg:block">
                                    <p className="font-semibold text-foreground leading-none">Chancen Rep</p>
                                    <p className="text-[10px] uppercase font-semibold text-muted-foreground mt-1 tracking-widest flex items-center gap-1">
                                        Sponsorship Partner <ChevronDown size={10} className={cn("transition-transform", isProfileOpen && "rotate-180")} />
                                    </p>
                                </div>
                                ...
                                {isProfileOpen && (
                                    ...
                                    >
                                        <div className="px-4 py-2 border-b border-border mb-1 lg:hidden">
                                            <p className="font-bold text-sm">Chancen Rep</p>
                                            <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Sponsorship Partner</p>
                                        </div>
                                        <button
                                            ...
                                            onClick={() => { router.push('/partner/settings'); setIsProfileOpen(false); }}
                                        >
                                            <SettingsIcon size={16} /> My Settings
                                        </button>
